...
path('api/payment/<int:trip_id>/record-payment/', views.record_payment_api, name='record_payment_api'),
path('api/payment/<int:payment_id>/update/', views.update_payment_api, name='update_payment_api'),
